        ...
        <article
            ...
            <form action="" class="w-full mx-auto space-y-5">
                ...
                <section class="w-full flex items-center gap-2">
                    ...
                    <input type="email" id="nama_program" name="nama_program" placeholder="Masukkan Email" required
                ...
                <section class="w-full flex items-center gap-2">
                    ...
                    <input type="password" id="nama_program" name="nama_program" placeholder="Masukkan Password" required
                        class="w-1/3 h-10 px-3.5 rounded-md border border-gray-400 text-neutral-800 text-base focus:outline-none focus:ring-2 focus:ring-brand-primary" />
                </section>
                ...
                <section class="w-full flex items-center gap-2">
                    ...
                    <input type="text" id="nama_program" name="nama_program" placeholder="Masukkan Jabatan" required
                        class="w-1/3 h-10 px-3.5 rounded-md border border-gray-400 text-neutral-800 text-base focus:outline-none focus:ring-2 focus:ring-brand-primary" />
                </section>
