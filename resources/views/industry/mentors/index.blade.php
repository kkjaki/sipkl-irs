...
@section('content')
    <article class="min-h-screen bg-brand-bg px-10">
        {{-- Header --}}
        <header>
        ...
        <div class="w-full mx-auto">
            <div
                ...
                <a href="{{ route('industry.mentors.create') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-t-0 rounded-b-lg">
                    <div
                        ...
                        <div class="self-stretch inline-flex justify-between items-start">
                            <div class="justify-start text-neutral-800 text-lg font-bold leading-snug">John Doe</div>
                            <div
                        ...
                        <div class="w-1/2 inline-flex justify-start items-center gap-2.5">
                            <a href="{{ route('industry.mentors.edit', ['mentor' => 1]) }}"
