...
@section('content')
    <div class="container mx-auto px-4 py-8" x-data="{
        ...
        <!-- Header Wadah -->
        <div
            class="bg-gradient-to-r from-teal-500 to-teal-600 p-4 {{ count($school) > 0 ? 'rounded-t-xl rounded-b-none border-b border-teal-600/50' : 'rounded-xl mb-6 shadow-sm' }} flex flex-col sm:flex-row justify-between items-center text-white gap-4 transition-all">
            ...
            <form method="GET" action="{{ route('grades.schools.index') }}" class="relative w-full md:w-64 shrink-0">
