...
<div class="container mx-auto px-4 py-8" x-data="{ 
    ...
    <!-- Header Wadah -->
    <div class="bg-gradient-to-r from-teal-500 to-teal-600 p-4 {{ count($logbooks) > 0 ? 'rounded-t-xl rounded-b-none border-b border-teal-600/50' : 'rounded-xl mb-6 shadow-sm' }} flex flex-col sm:flex-row justify-between items-center text-white gap-4 transition-all">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4" x-ref="grid">
            @forelse($logbooks as $logbook)
                <div x-show="search === '' || $el.innerText.toLowerCase().includes(search.toLowerCase())"
                     ...
                     class="student-card-data bg-white rounded-xl border border-gray-100 p-5 relative flex flex-col h-full"
    ...
    <div class="text-center py-12 bg-white rounded-xl shadow-sm border border-dashed border-gray-200">
        <svg class="w-12 h-12 text-gray-400 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
