            ...
            <div class="space-y-4 mb-8 pb-8 border-b border-gray-100">
                ...
                <div>
                    ...
                    @if($logbook->documentation_file)
                        <a href="{{ Storage::url($logbook->documentation_file) }}" target="_blank" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 font-medium bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg transition-colors">
