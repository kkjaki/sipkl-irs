<x-app-layout>
    <div class="min-h-screen bg-brand-bg px-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div
                ...
                <div
                    class="bg-brand-primary text-white p-4 font-bold text-lg">
                    Sesi Presensi
                </div>
                <div class="p-6">
                    <div class="space-y-3 mb-4">
                        <div class="flex border-b py-2">
                            <span
                                class="w-40 font-medium text-gray-700">Industri</span>
                        ...
                        <div class="flex border-b py-2">
                            <span
                                class="w-40 font-medium text-gray-700">Tanggal</span>
                            <span class="mx-2">:</span>
                            <span
                                class="flex-1 text-gray-900">
                                {{ date('d F Y',
                        ...
                        <div class="flex border-b py-2">
                            <span
                                class="w-40 font-medium text-gray-700">Batas
                                Waktu</span>
                            <span class="mx-2">:</span>
                            <span
                                class="flex-1 text-gray-900">
                                {{ date('H:i',
                                strtotime($session->on_time_deadline))
                                }}
                            </span>
                        </div>
                        <div class="flex border-b py-2">
                            <span
                                class="w-40 font-medium text-gray-700">Dibuka
                                Oleh</span>
                            <span class="mx-2">:</span>
                            <span
                                class="flex-1 text-gray-900">
                        ...
                        <div class="flex py-2">
                            <span
                                class="w-40 font-medium text-gray-700">Status</span>
                            <span class="mx-2">:</span>
                            <span class="flex-1">
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <span
                                    class="w-32 text-gray-600">Status:</span>
                                <span
                            ...
                            <div class="flex items-center">
                                <span
                                    class="w-32 text-gray-600">Waktu
                                    Check-in:</span>
                                <span
                            ...
                            <div class="flex items-start">
                                <span
                                    class="w-32 text-gray-600">Foto:</span>
                            ...
                            <div class="flex items-start">
                                <span
                                    class="w-32 text-gray-600">Catatan:</span>
                                <span
                                    class="font-medium text-gray-900">{{
                                    $session->attendance_data->notes
                                    }}</span>
                            </div>
                            @endif
                        </div>
    ...
    <div id="loadingOverlay"
        ...
        <div
            class="bg-white rounded-lg p-8 flex items-center gap-4">
            <svg class="animate-spin h-8 w-8 text-brand-primary"
            ...
            <span
                class="text-gray-800 font-semibold">Menyimpan
                presensi...</span>
        </div>
    </div>
    ...
    <script>
        ...
        async function startCamera() {
            ...
            try {
                ...
                errorMsg.textContent = 'Tidak dapat mengakses kamera. Silakan gunakan tombol upload atau izinkan akses kamera.';
